...
## Pmodb - Attempt #1, #2 uncomment pullup lines
...
### Pmodb - Attempt #3, #4 ucnomment pullup lines
#set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {esp32_Tx}]
#set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {esp32_cts}]
#set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {esp32_rts}]
#set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {esp32_Rx}]
#set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {esp32_reset}]
#set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {esp32_intr}]
#set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {esp32_gpio}]
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {esp32_select}]
#set_property PULLUP true [get_ports {esp32_Rx}]
#set_property PULLUP true [get_ports {esp32_rts}]
#set_property PULLUP true [get_ports {esp32_select]
#set_property PULLUP true [get_ports {esp32_gpio}]
